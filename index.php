    ...
    <main class="main">
        ...
        <section class="section hero">
            <div class="container">
                ...
                <div class="wow animate__animated animate__fadeInUp hero__btn-box">
                    <button class="btn btn-white btn-order">Хочу консультацию</button>
                    <button class="btn btn-black btn-request">Оставить заявку</button>
                </div>
            </div>
        </section>
        <!-- /.section hero -->
        ...
        <section class="section works" id="works">
            <div class="container">
                <div class="works__info-menu">
                    <div class="wow animate__animated animate__fadeInLeft works__info-box">
                    ...
                    <div class="wow animate__animated animate__fadeInRight works__menu-box">
                        <ul class="works__menu-list">
                            <li class="works__menu-item"><a id="naming-logos" href="#" class="works__menu-link works__menu-link_active">Нейминг и логотипы</a></li>
                            <li class="works__menu-item"><a id="video-clip" href="#" class="works__menu-link">Видеоролик</a></li>
                            <li class="works__menu-item"><a id="sound-advertising" href="#" class="works__menu-link">Звуковая реклама</a></li>
                            <li class="works__menu-item"><a id="site-seo" href="#" class="works__menu-link">Сайт/продвижение</a></li>
                            <li class="works__menu-item"><a id="smm" href="#" class="works__menu-link">SMM</a></li>
                            <li class="works__menu-item"><a id="design" href="#" class="works__menu-link">Дизайн рекламы</a></li>
                            <li class="works__menu-item"><a id="label" href="#" class="works__menu-link">Этикетка/упаковка</a></li>
                            <li class="works__menu-item"><a id="food-shooting" href="#" class="works__menu-link">предметная и Food съёмка</a></li>
                        </ul>
                ...
                <div class="wow animate__animated animate__fadeInUp works__example-wrap">

                    <div class="works__example-box">
                        <a href="example.php"><img src="images/example-1.png" alt=""></a>
                    </div>

                    <div class="works__example-box">
                        <a href="example.php"><img src="images/example-2.png" alt=""></a>
                    </div>

                    <div class="works__example-box">
                        <a href="example.php"><img src="images/example-3.png" alt=""></a>
                    </div>

                    <div class="works__example-box">
                        <a href="example.php"><img src="images/example-4.png" alt=""></a>
                    </div>

                    <div class="works__example-box">
                        <a href="example.php"><img src="images/example-5.png" alt=""></a>
                    </div>

                    <div class="works__example-box">
                        <a href="example.php"><img src="images/example-6.png" alt=""></a>
                    </div>

                    <div class="works__example-box">
                        <a href="example.php"><img src="images/example-7.png" alt=""></a>
                    </div>

                    <div class="works__example-box">
                        <a href="example.php"><img src="images/example-8.png" alt=""></a>
                    </div>
        ...
        <section class="section comands" id="comands">
            <div class="container">
                <h2 class="wow animate__animated animate__fadeInUp section__title section__title_center">Наша команда</h2>
                <div class="comands__wrap">
                    ...
                    <div class="wow animate__animated animate__fadeInRight comands__people">
                ...
                <div class="wow animate__animated animate__slideInUp review__wrap">
                    ...
                    <div class="review-box">
                        <div class="review__man-box">
                            ...
                            <div class="review__name">Илон Макс</div>
                            <p class="review__company">Компания Tesla</p>
                            <p class="review__city">г.Киров</p>
                            <p class="review__project">Наши проекты:</p>
                            <ul class="review__list">
                                <li class="review__item">Рекламная кампания «Даешь удачу»</li>
        ...
        <div class="wow animate__animated animate__fadeInDown slider-company">
            <div class="container slider__wrap-container">
                <div class="slider__wrap owl-carousel owl-theme">
                    <div class="slider__box"><img class="slider__img" src="images/company-1.svg" alt=""></div>
                    <div class="slider__box"><img class="slider__img" src="images/company-2.svg" alt=""></div>
                    <div class="slider__box"><img class="slider__img" src="images/company-3.svg" alt=""></div>
                    <div class="slider__box"><img class="slider__img" src="images/company-4.svg" alt=""></div>
                    <div class="slider__box"><img class="slider__img" src="images/company-5.svg" alt=""></div>
                    <div class="slider__box"><img class="slider__img" src="images/company-4.svg" alt=""></div>
                    <div class="slider__box"><img class="slider__img" src="images/company-2.svg" alt=""></div>
                </div>
        ...
        <section class="section contacts" id="contacts">
            ...
            <div class="container">
                ...
                <div class="contacts__wrap">
                    <div class="wow animate__animated animate__slideInLeft contacts__box">
                    ...
                    <div class="wow animate__animated animate__slideInRight contacts__btn-box">
                        <button class="btn btn-black btn-request">Оставить заявку</button>
                    </div>
                </div>
            </div>
